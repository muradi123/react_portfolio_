    ...
    <div className="background_img">
      <div className="header">
        ...
        <div className="header-main-container">
            ...
            <div className="header-main-container_text animate__animated animate__fadeInUp">
